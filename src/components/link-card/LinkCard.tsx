...
export default component$<{ name: string; src: string }>(({ name, src }) => {
	return (
		<Link href="/" class="min-h-[100px] min-w-[50px]">
			<div class="relative rounded-lg overflow-hidden">
				<Image layout="fixed" width="300" height="300" src={src} alt={name} />
