...
export function getSdk<C>(requester: Requester<C>) {
  return {
    ...
    GetWebsite(variables?: GetWebsiteQueryVariables, options?: C): Promise<GetWebsiteQuery> {
      return requester<GetWebsiteQuery, GetWebsiteQueryVariables>(GetWebsiteDocument, variables, options) as Promise<GetWebsiteQuery>;
    }
  };
}
